...
describe('Butterfly', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks()
    butterfly = new Butterfly('small', 0xff0000, 0x00ff00, 1, mockScreenSize)
  })
  ...
  describe('Constructor', () => {
    ...
    it('should initialize large butterfly with different speed', () => {
      const largeButterly = new Butterfly('large', 0xff0000, 0x00ff00, 1, mockScreenSize)
    ...
    it('should initialize medium butterfly', () => {
      const mediumButterfly = new Butterfly('medium', 0xff0000, 0x00ff00, 1, mockScreenSize)
      expect(mediumButterfly).toBeDefined()
    })

    it('should initialize special butterfly', () => {
      const specialButterfly = new Butterfly('special', 0xff0000, 0x00ff00, 1, mockScreenSize)
      expect(specialButterfly).toBeDefined()
    })

    it('should handle random size selection', () => {
      const randomButterfly = new Butterfly('random', 0xff0000, 0x00ff00, 1, mockScreenSize)
      expect(randomButterfly).toBeDefined()
    })

    it('should handle multiplication rate >= 2', () => {
      const multiButterfly = new Butterfly('small', 0xff0000, 0x00ff00, 3, mockScreenSize)
  ...
  describe('update()', () => {
    it('should call flap and fly methods', () => {
      const flapSpy = vi.spyOn(butterfly as any, 'flap').mockImplementation(() => {})
      const flySpy = vi.spyOn(butterfly as any, 'fly').mockImplementation(() => {})
  ...
  describe('fly() method behavior', () => {
    ...
    it('should avoid line segments', async () => {
      ...
      const UtilityMock = vi.mocked(await import('../../../src/scripts/utils/Utility'))
