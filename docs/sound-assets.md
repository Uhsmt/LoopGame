...
| S8'   | se_applause.m4a        | Clapping hurray (starlite)       | Wikimedia Commons       | Public Domain | 1.2〜4.4秒を切り出し+フェード(New Record時) |
...
| S11   | se_tick.m4a            | tick_001                         | Kenney Interface Sounds | CC0           | AAC変換のみ                                 |
